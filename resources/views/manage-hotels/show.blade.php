...
<div class="row">
	<div class="col-md-8">
		...
		<p><small>{{ $hotel->address->hotel_address }}, {{ $hotel->address->hotel_phone_number }}, <a href="mailto:{{ $hotel->address->hotel_email_address }}">{{ $hotel->address->hotel_email_address }}</a>, <a href="http://{{ $hotel->address->hotel_website }}" target="_blank">{{ $hotel->address->hotel_website }}</a></small></p>
